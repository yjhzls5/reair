...
public class DbKeyValueStore {
    ...
    public DbKeyValueStore(DbConnectionFactory dbConnectionFactory,
                           String dbTableName) throws SQLException {
    ...
    public void set(String key, String value) throws SQLException {
        ...
        String query = String.format(
                ...
                "VALUE (?, ?) ON DUPLICATE KEY UPDATE value_string = ?",
                dbTableName);
    ...
    public static int main(String [] args) throws Exception {
        String jdbcUrl =
                "jdbc:mysql://pinkybrain-hive.cqmqbyzxdwlk." +
                        "us-east-1.rds.amazonaws.com:3306/hive_replication";
        String dbUser = DbCredentials.getUsername();
        String dbPass = DbCredentials.getPassword();

        DbConnectionFactory dbConnectionFactory =
                new StaticDbConnectionFactory(jdbcUrl, dbUser, dbPass);
        DbKeyValueStore kvStore = new DbKeyValueStore(dbConnectionFactory,
                "key_value");

        kvStore.set("foo", "bar");
        System.out.println("fruit is " + kvStore.get("fruit"));
        System.out.println("vegetable is " + kvStore.get("vegetable"));
        System.out.println("foo is " + kvStore.get("foo"));
        System.out.println("bar is " + kvStore.get("bar"));
        return 0;
    }*/
}
