...
public class DistCpWrapperOptions {
    ...
    public DistCpWrapperOptions(Path srcDir,
                                Path destDir,
                                Path distCpTmpDir,
                                Path distCpLogDir) {
        this.srcDir = srcDir;
    ...
    public DistCpWrapperOptions setSyncModificationTimes(
    ...
    public DistCpWrapperOptions setLocalCopyThreshold(
            long localCopyThreshold) {
