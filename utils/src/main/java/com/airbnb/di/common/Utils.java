...
public class Utils {
    ...
    public static <ReturnType, ExceptionType extends Throwable>
    ReturnType executeWithRetry(
            Command<ReturnType, ExceptionType> command,
                    int attempts, long baseWait, int exponent,
                    int maxWaitTime) {
