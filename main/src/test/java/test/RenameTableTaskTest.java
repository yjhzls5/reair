...
public class RenameTableTaskTest extends MockClusterTest {
    ...
    public void testRenameTable() throws IOException,
        ...
        RenameTableTask job = new RenameTableTask(testConf,
                ...
                originalTableSpec,
                newTableSpec,
                ReplicationUtils.getLocation(originalSrcTable),
                ReplicationUtils.getLocation(srcTable),
                ReplicationUtils.getTldt(originalSrcTable),
                jobExecutor,
                directoryCopier);
        ...
        assertTrue(destMetastore.existsTable(newTableSpec.getDbName(),
                newTableSpec.getTableName()));
        assertFalse(destMetastore.existsTable(originalTableSpec.getDbName(),
                originalTableSpec.getTableName()));
    ...
    @Test
    public void testRenameTableReqiringCopy() throws IOException,
            HiveMetastoreException, DistCpException {
        String dbName = "test_db";
        String tableName = "test_table";
        String newTableName = "new_test_table";
