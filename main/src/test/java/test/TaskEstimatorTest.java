...
public class TaskEstimatorTest extends MockClusterTest {
    ...
    @Test
    public void testEstimatesForUnpartitionedTable() throws IOException,
        ...
        TaskEstimator estimator = new TaskEstimator(conf,
        ...
        assertTrue(estimate.getTaskType() ==
        ...
        ReplicationTestUtils.createTextFile(conf,
                new Path(srcTable.getSd().getLocation()),
                "new_file.txt",
                "456");
        estimate = estimator.analyze(spec);
    ...
    @Test
    public void testEstimatesForPartitionedTable() throws IOException,
            HiveMetastoreException, DistCpException {
    ...
    @Test
    public void testEstimatesForPartition() throws IOException,
            HiveMetastoreException, DistCpException {
        ...
        HiveObjectSpec spec = new HiveObjectSpec(HIVE_DB,
                HIVE_TABLE,
                HIVE_PARTITION);
        Partition srcPartition = ReplicationTestUtils.createPartition(
                conf,
                srcMetastore,
                spec);
        ...
        estimate = estimator.analyze(spec);
        assertTrue(estimate.getTaskType() ==
                TaskEstimate.TaskType.DROP_PARTITION);
    }
}
