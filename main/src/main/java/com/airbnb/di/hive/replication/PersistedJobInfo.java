...
public class PersistedJobInfo {
    ...
    public static final String AUDIT_LOG_ID_EXTRAS_KEY =
            "audit_log_id";
    public static final String AUDIT_LOG_ENTRY_CREATE_TIME_KEY =
            "audit_log_entry_create_time";
    public static final String BYTES_COPIED_KEY =
            "bytes_copied";
    ...
    public PersistedJobInfo(Long id,
                            Long createTime,
    ...
    public String toString() {
        return "PersistedJobInfo{" +
                ...
                ", srcPartitionNames=" + srcPartitionNames +
                ", srcObjectTldt='" + srcObjectTldt + '\'' +
                ", renameToDb='" + renameToDb + '\'' +
                ", renameToTable='" + renameToTable + '\'' +
                ", renameToPartition='" + renameToPartition + '\'' +
    ...
    public boolean equals(Object o) {
        ...
        if (renameToDb != null ? !renameToDb.equals(that.renameToDb) : that.renameToDb != null)
            return false;
        if (renameToPartition != null ? !renameToPartition.equals(that.renameToPartition) : that.renameToPartition != null)
            return false;
        if (renameToPath != null ? !renameToPath.equals(that.renameToPath) : that.renameToPath != null)
            return false;
        if (renameToTable != null ? !renameToTable.equals(that.renameToTable) : that.renameToTable != null)
            return false;
        if (srcClusterName != null ? !srcClusterName.equals(that.srcClusterName) : that.srcClusterName != null)
            return false;
        if (srcDbName != null ? !srcDbName.equals(that.srcDbName) : that.srcDbName != null)
            return false;
        if (srcObjectTldt != null ? !srcObjectTldt.equals(that.srcObjectTldt) : that.srcObjectTldt != null)
            return false;
        if (srcPartitionNames != null ? !srcPartitionNames.equals(that.srcPartitionNames) : that.srcPartitionNames != null)
            return false;
