    ...
    public void start() {
        timer.scheduleAtFixedRate(
                new TimerTask() {
                    @Override
                    public void run() {
                        ReplicationJob jobWithSmallestId =
                                jobRegistry.getJobWithSmallestId();
                        if (jobWithSmallestId == null) {
                            ...
                            LOG.debug(String.format("Oldest ID: %s Age: %s",
                                    jobWithSmallestId.getId(),
                                    age));
                        }
                    }
                },
