...
public class WebServer {
    ...
    public static void main(final String[] argv) throws Exception {
        ...
        options.addOption(OptionBuilder.withLongOpt("thrift-host")
                .withDescription("Host name for the thrift service")
                .hasArg()
                .withArgName("HOST")
                .create());

        options.addOption(OptionBuilder.withLongOpt("thrift-port")
                .withDescription("Port for the thrift service")
                .hasArg()
                .withArgName("PORT")
                .create());

        options.addOption(OptionBuilder.withLongOpt("http-port")
                .withDescription("Port for the HTTP service")
                .hasArg()
                .withArgName("PORT")
                .create());
        ...
        LOG.info(String.format("Connecting to thrift://%s:%s and " +
                "serving HTTP on %s",
                finalThriftHost,
                finalThriftPort,
                httpPort));
